...
# Just the disclaimer, no captions (skip the caption pass — would need extracting just the disclaimer overlay logic)
# → not currently a flag; would need to call the disclaimer overlay code directly
```
