"""
CA Women CWL6_F1 — 'Chest Tightening' finalize:
  word-aware trim → stitch → static loudnorm → watermark crop (9:16)
Persona: CWL6_F1_v3 — Ecuadorian mestiza 52, outdoor CA apartment front steps
...
DISC = Path("outputs")   # dissect outputs land at outputs/ca_women_cwl6f1_cam1_clip{n}/
...
def word_trim(n):
    ...
    tx_path = DISC / f"ca_women_cwl6f1_cam1_clip{n}" / "transcript.json"
