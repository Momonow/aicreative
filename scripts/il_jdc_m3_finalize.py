...
INTENDED = {
    1: "Most people who qualify for this dont file because they dont know the deadline exists",
    2: "Thats exactly what Illinois is counting on after it passes they owe you nothing",
    3: "If you were in an Illinois juvenile facility as a kid and a guard or staff member sexually abused you",
    4: "there is a legal window open right now to file a claim",
    5: "Most people who were in those facilities have no idea this is happening",
    6: "Illinois has not been loud about it you may qualify for significant compensation",
    7: "You dont have to come in no phone calls private and confidential free to check",
    8: "Two minutes to check if you qualify go look now while the window is still open tap below",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"il_jdc_m3_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/m3_clip{n}_in.mp3"
