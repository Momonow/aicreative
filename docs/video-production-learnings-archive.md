# Video Production Learnings Archive

> Archived from the former always-on `CLAUDE.md` on 2026-07-23. Use this as a searchable incident and provider-history reference. Current rules and routing live in `/Users/harry/aicreative/CLAUDE.md` and the general video skills.
