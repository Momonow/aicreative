...
CLIPS = [
    ...
    },
    {
        "n": 4,
        "prompt": (
            "GAZE: Eyes on the dash camera. Quiet. Heavy. Holds the lens the whole clip.\n"
            "BODY LANGUAGE: Parked-car driver seat. Phone low on dash, camera angle looking up. "
            "Completely still — no lean, no shift. One hand resting on wheel, other in lap. Head level.\n"
            "VOICE STYLE: Same low voice. Quieter — flat, plain.\n"
            "TONE: The flatness of a closed chapter. Settled and still.\n"
            "SPEED: ~1.8 wps. Slow and deliberate.\n\n"
            "CRITICAL — BACKGROUND LOCK: Through the windshield is a SOLID STATIC surface — "
            "a concrete wall, brick building facade, or parking structure directly in front of the car. "
            "NO trees. NO leaves. NO sky. NO outdoor greenery. NO moving elements of any kind. "
            "The background visible through the glass is a FLAT STILL WALL that does NOT move, "
            "blur, scroll, or change at any point. The outside world is COMPLETELY FROZEN.\n\n"
            "CRITICAL — CAR STATIONARY: The car does NOT move, roll, or drive at any point. "
            "Engine off. PARKED. STILL. The interior does NOT shift. ZERO vehicle motion.\n\n"
            "AUDIO CRITICAL: Speaks CLEARLY AUDIBLY despite quiet tone. NOT inaudible. "
            "ZERO fillers. ONLY the exact words.\n\n"
            "CRITICAL — EYES ON CAMERA: Eyes stay aimed at the lens the full clip.\n\n"
            "CRITICAL — NO SMILE EVER: ZERO upturned corners.\n\n"
            "CRITICAL — DIALOGUE LOCK: English only. No fillers. No trailing words. "
            "Speak ONLY the EXACT words below in order and STOP after the final word.\n\n"
    ...
    },
    {
        "n": 5,
        "prompt": (
            "GAZE: Eyes on the dash camera — direct, calm, aimed at the lens the full clip.\n"
            "BODY LANGUAGE: Parked-car driver seat. Phone low on dash, camera looks up slightly. "
            "Completely still — NO lean, NO shift, NO movement. One hand resting on wheel. Head level.\n"
            "VOICE STYLE: Same low voice, steady and factual.\n"
            "TONE: Quiet certainty. Plain and factual.\n"
