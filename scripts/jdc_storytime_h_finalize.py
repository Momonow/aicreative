...
clean 9:16 720x1280 (~8% zoom, no distortion). Output: outputs/illinois_jdc_storytime_h_b10/story_h_b10_final.mp4
"""
import json, subprocess, re, sys
from pathlib import Path

SRC = Path("outputs/illinois_jdc_storytime_h_b10")
...
def main():
    ...
    for cid in clips:
        ...
        trans = Path(f"outputs/jdc_h_b10_{cid}/transcript.json")
        if trans.exists():
    ...
    final = SRC / "story_h_b10_final.mp4"
