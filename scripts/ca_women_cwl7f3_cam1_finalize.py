"""
CA Women CWL7_F3 — 'Three Lies' finalize:
...
DISC = Path("outputs")   # dissect outputs land at outputs/ca_women_cwl7f3_cam1_clip{n}/

# ── intended dialogue per clip (for word-aware trailing trim) ─────────────────
INTENDED = {
    1: "three lies california womens prison staff told women to make sure youd never file a sexual abuse compensation claim",
    2: "lie one if you didnt report it at the time its too late",
    3: "lie two its your word against ours",
    4: "lie three this is just how it works in here",
    5: "none of those are true",
    6: "women abused by staff at chowchilla valley state folsom and ciw",
    7: "may qualify for significant potential compensation years later no report needed no witness",
    8: "simple no one in your life finds out you looked",
    9: "free and completely confidential to check tap below",
}
...
def word_trim(n):
    ...
    tx_path = DISC / f"ca_women_cwl7f3_cam1_clip{n}" / "transcript.json"
