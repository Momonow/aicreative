...
INTENDED = {
    1: "The reason Illinois settled these cases without telling anybody is simple every survivor who doesnt know is money they keep",
    2: "If you were in Illinois juvie as a minor and you were abused",
    3: "You are one of the people theyre hoping doesnt come forward",
    4: "Heres how this works Illinois had a legal duty to protect kids in their custody",
    5: "When staff abused those kids the state became liable they know a jury would not be kind to them",
    6: "So theyve been settling quietly hoping survivors never connect the dots active claims are moving right now",
    7: "Significant compensation is on the table there is a deadline and it is not flexible",
    8: "Its private nobody in your life finds out no cost unless they win",
    9: "Two minutes to check tap below to see if you qualify",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"il_jdc_m2_clip{n}" / "transcript.json"
    ...
    # subsequence match to last intended word
    j = 0
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/m2_clip{n}_in.mp3"
    ...
    # crop letterbox to clean 9:16 (720x1280)
    ...
    print(f"\nDONE → {cropped}")
    print("Next: caption_hormozi3.py on stitched_916.mp4")
