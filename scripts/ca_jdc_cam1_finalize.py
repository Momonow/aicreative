"""
CA JDC B1 "The Files Are Finally Open" finalize:
  word-aware trim → voice clone (clip1) → voice_changer → loudnorm → stitch
Persona: CA_M1_v4 — Venice Beach boardwalk, 31yo
"""
...
INTENDED = {
    1: "nobody was supposed to find out what happened inside californias juvenile facilities",
    ...
    9: "the window does not stay open forever tap below and find out where you stand before it closes",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_jdc_cam1_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/ca_cam1_clip{n}_in.mp3"
