"""Story C (Illinois juvie storytime, "How they bought my silence") — persona bed_b10.
...
SLUG = "illinois_jdc_storytime_h_b10"
OUT = Path(f"outputs/{SLUG}"); OUT.mkdir(parents=True, exist_ok=True)
HOST_IMG = "outputs/illinois_jdc_storytime_bed/reference/bed_b10.png"
...
CLIPS = [
    ("clip01", "A guard SA'ed me at Illinois juvie. This is my story.",
    ...
    ("clip03", "I was sixteen, locked up, and I had nothing coming to me. No money, no visits, nobody.",
     "Matter-of-fact, quiet.", "Faint, tired eyes.", PRON_PLAIN),
    ("clip04", "After it would happen, he'd hook me up. Fast food he snuck in. Cigarettes. Extra time on the games.",
     "Quiet, remembering with a dull ache.", "Eyes drift, then settle.", PRON_PLAIN),
    ("clip05", "And because I took it, I spent years thinking that made me part of it somehow.",
     "Hollow, the shame surfacing.", "Looks down then back.", PRON_PLAIN),
    ("clip06", "I was a kid. He was a grown man with all the power, using the only things I wanted to keep me quiet.",
     "A quiet, certain edge, reframing it.", "Slow small head shake.", PRON_PLAIN),
    ("clip07", "So I took the stuff and said nothing. That was the whole point. Keep me fed, keep me quiet.",
     "Defeated, vulnerable.", "Soft tired eyes.", PRON_PLAIN),
    ("clip08", "I buried it til I was grown. Then I found out how many of us he did that to.",
    ...
    ("clip14", "The law changed so you can still come forward, but there are deadlines. In part two I'll tell you what taking those snacks really cost me.",
