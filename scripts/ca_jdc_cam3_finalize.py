"""
CA JDC cam3 finalize:
  word-aware trim → voice clone (clip1) → voice_changer → loudnorm → stitch
Persona: CA_M3_v1 — Apartment living room, 29yo
"""
...
INTENDED = {
    1:  "right now today california is paying out on a wave of cases most survivors still dont know exists",
    2:  "here is whats happening for decades kids locked in california juvenile facilities were kept quiet by the people running them",
    3:  "those staff members sexually abused them those facilities covered it up",
    4:  "now the law has caught up and hundreds of former detainees have already stepped forward",
    5:  "every one of them was where you were once a minor locked up told to stay quiet",
    6:  "you dont have to stay quiet anymore you dont have to prove anything from back then",
    7:  "no report no records if you remember the facility and you can describe who did it",
    8:  "you may qualify for significant potential compensation but these claims run on a deadline",
    9:  "the people moving first are moving now the check is free its confidential and its under a minute",
    10: "tap below before your window closes dont let this be one more thing they took from you",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_jdc_cam3_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/ca_cam3_clip{n}_in.mp3"
