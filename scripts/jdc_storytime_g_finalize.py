...
clean 9:16 720x1280 (~8% zoom, no distortion). Output: outputs/illinois_jdc_storytime_g_b11/story_g_b11_final.mp4
"""
import json, subprocess, re, sys
from pathlib import Path

SRC = Path("outputs/illinois_jdc_storytime_g_b11")
...
def main():
    ...
    for cid in clips:
        ...
        trans = Path(f"outputs/jdc_g_b11_{cid}/transcript.json")
        if trans.exists():
    ...
    final = SRC / "story_g_b11_final.mp4"
