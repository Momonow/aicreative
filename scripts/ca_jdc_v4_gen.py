...
CLIPS = [
    {
        "n": 1,
        "prompt": (
            "GAZE: Eyes OPEN and aimed FORWARD at the lens — he is TELLING someone, not remembering. "
            "All of his energy is directed OUTWARD and FORWARD into the camera. "
            "Eyes do NOT drop, do NOT go inward, do NOT close. "
            "His gaze stays LIFTED and LOCKED on the lens even when the words are heavy.\n"
            "BODY LANGUAGE: Close-up documentary framing — camera at eye level, NOT a selfie. "
            "Both arms relaxed at sides, one hand loosely in pocket. Head level. Still.\n"
            "VOICE STYLE: Deep, low, measured. Late 30s. Direct delivery outward — not internal.\n"
            "TONE: Forward, not inward. He is CONFRONTING the viewer with what happened — "
            "delivering the weight AT the camera, not retreating into it. Controlled. Flat.\n"
            "SPEED: ~2.2 wps. Brief pause after 'shut.' 'troubled kid' lands flat and final.\n\n"
            ...
            "EYES OPEN — ABSOLUTE LOCK: Dark eyes stay OPEN and AIMED at the lens every single frame. "
            "ZERO downward glances. ZERO eye closure. ZERO looking inward. "
            "Even during heavy emotional words — his eyes stay FORWARD ON THE LENS. "
            "He does NOT look down, not even for a frame.\n\n"
