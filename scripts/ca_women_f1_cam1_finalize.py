"""
CA Women F1 cam1 finalize:
  word-aware trim → voice clone (clip1) → voice_changer → loudnorm → stitch → crop
Persona: CW_F1 — Latina 52, Central Valley porch
"""
...
INTENDED = {
    1:  "im fifty two years old i got grandkids running around this house i have not thought about chowchilla in years",
    2:  "and i almost deleted my sisters text without opening it she sent me a link about women who were in california facilities",
    3:  "women who were abused by staff finding out they may qualify for significant potential compensation",
    4:  "i sat on it for two weeks i wasnt carrying it anymore id put it down a long time ago",
    5:  "the last thing i wanted was to pick it back up what i found out was it didnt have to be like that",
    6:  "it took less than a minute to check nobody asked me to relive anything",
    7:  "no court no record no proof i didnt have just fill out a form in 60 seconds",
    8:  "the attorneys reviewed what i shared in confidence and told me where i stand thats it that was the whole thing",
    9:  "im not telling you what to do im telling you i almost let the window close",
    10: "because i thought it would cost me something it didnt cost me youve been through enough this part is easy",
    11: "tap below free and private see where you stand",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_women_f1_cam1_clip{n}" / "transcript.json"
    ...
    # 0.30s lead-in so voice_changer never drops the first word
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/cw_f1_clip{n}_in.mp3"
