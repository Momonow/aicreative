...
clean 9:16 720x1280 (~8% zoom, no distortion). Output: outputs/illinois_jdc_storytime_c_b5/story_c_b5_final.mp4
"""
import json, subprocess, re, sys
from pathlib import Path

SRC = Path("outputs/illinois_jdc_storytime_c_b5")
...
def main():
    ...
    for cid in clips:
        ...
        trans = Path(f"outputs/jdc_c_b5_{cid}/transcript.json")
        if trans.exists():
    ...
    final = SRC / "story_c_b5_final.mp4"
